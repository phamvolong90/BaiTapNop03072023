...
import { CHANGE_ASSIGNESS, CHANGE_TASK_MODAL, GET_TASK_DETAIL, REMOVE_USER_ASSIGN } from "../constant/Cyberbugs/TaskConstants"
const initialState = {
    taskDetailModal:  {
      "priorityTask": {
        "priorityId": 1,
      ...
      "lstComment": [
        {
          ...
          "name": "Long",
          "commentContent": "<p>taskDetailModal lstComment Example commentContent Long<p>"
        },
        {
          "idUser": 1000,
          "avatar": "https://ui-avatars.com/api/?name=Chau",
          "name": "Chau",
          "commentContent": "<p> taskDetailModal lstComment Example commentContent Chau<p>"
        }
      ],
      "taskId": null,
      "taskName": "task 1",
