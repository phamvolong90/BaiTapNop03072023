...
} from "../../../redux/constant/Cyberbugs/TaskConstants";
...
export default function ModalCyberBugs(props) {
  ...
  //     return (
  //       <div className="comment" key={index}> abc
  //       <h6>Comment</h6>
              ...
              <div className="row">
                <div className="col-8">
                  ...
                  <div className="comment">
                    <h6>Comment</h6>
                    <JiraTaskMainComment taskId={taskDetailModal.taskId} />
                    {renderCommentArr()}
