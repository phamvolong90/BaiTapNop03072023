...
import FormCreateTask from '../../components/Cyberbugs/Forms/FormCreateTask/FormCreateTask';
...
export default function SidebarCyberbugs() {
    ...
    return (
        <div>
            <Sider  trigger={null} collapsible collapsed={state.collapsed} style={{ backgroundColor:'black', height: '100%' }}>
